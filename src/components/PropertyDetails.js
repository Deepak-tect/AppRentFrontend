...
//         </p>
//         <p>
//           <strong>Rent Price:</strong> ${property.price}
//         </p>
//         <p>
//           <strong>Availability Date:</strong> {property.availabilityDate}
//         </p>
//         <p>
//           <strong>Nearby Amenities:</strong> {property.amenities.join(", ")}
//         </p>
//         <button
//           onClick={() => handleClick(property._id)}
//           disabled={interested}
//           className={interested ? "disabled-button" : ""}
//         >
//           I'm Interested
//         </button>
//       </div>
...
//           </p>
//           <p>
//             <strong>Contact No:</strong> {userDetails.phoneNumber}
//           </p>
//         </div>
//       )}
//     </>
...
function PropertyDetails() {
  ...
  const handleClick = async (propertyId) => {
    try {
      const data = await getUser(propertyId);
      setUserDetails(data.data);
      setInterested(true);
    } catch (error) {
      console.log('Error message:', error.message);
      if (error.message.includes('Interest already expressed in this property')) {
        alert('You have already expressed interest in this property.');
      } else {
        console.error('Error details:', error);
        alert('Failed to express interest. Please try again later.');
      }
    }
  };
